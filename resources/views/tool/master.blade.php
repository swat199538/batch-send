...
<div class="wrapper">
    ...
    <script>
        ...
        function getwfs(source){
            wfs.html('<a style="height:26px;" href="http://tassistant.smsbao.com/unsent"><img src="/images/v2/sms.png" style="height:20px;width:20px;"><div class="num">未提交短信'+source+'条</div></a>')
        }
