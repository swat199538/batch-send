                    ...
                    <div class="sms-content">
                        <form >
                            ...
                            <div class="group-sms">
                                ...
                                <div class="right">
                                    <a class="btn-style">导入号码</a>
                                    <a id="check-phone" class="btn-style">检查输入</a>
                                    <a href="http://www.dxbtool.com/tool/download" class="download">下载导入模版</a>
                            ...
                            <div class="group-sms">
                                ...
                                <div class="right">
                                    ...
                                    <p class="input-info"><span class="notice-icon"></span>已输入<span>2</span>字,最多500字(含签名)</p>
                                    <p><a class="btn-style">发送</a></p>
                                </div>
                            </div>
